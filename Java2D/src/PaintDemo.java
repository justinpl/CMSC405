 ...
 * The program requires two image files, TinySmiley.png and 
 * QueenOfHearts.png to be available as resources on the class path
 * when the program is run.
 * 
 * This program is an example from the free on-line Java
 * textbook http://math.hws.edu/javanotes
 */
